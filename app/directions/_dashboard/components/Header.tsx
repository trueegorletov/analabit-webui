  ...
  return (
    <div className='mb-8 text-center'>
      <div 
        ...
        style={{
          background: 'linear-gradient(120deg, rgba(125, 226, 252, 0.6), rgba(102, 153, 255, 0.6))',
          ...
          boxShadow: '0 0 14px 3px rgba(110, 190, 253, 0.3), 0 0 6px 1.5px rgba(255, 255, 255, 0.12)',
          border: 'none'
        }}
      >
        СПбГУ
      ...
      <div className='mx-auto max-w-fit'>
        <h1 className='text-4xl md:text-4xl sm:text-3xl xs:text-2xl font-bold text-white mb-1 transition-all duration-300 hover:text-gray-100 relative inline-block'>
          ...
          <span 
            ...
            style={{
              background: 'linear-gradient(90deg, transparent, rgba(125, 226, 252, 0.8), transparent)',
