...
function StatCard({ value, label }: StatCardProps) {
  return (
    <Card className="bg-gradient-to-br from-[#1A1A20] to-[#15151A] border border-white/10 rounded-xl aspect-[4/3] w-full transition-all duration-300 hover:from-[#1F1F26] hover:to-[#1A1A20] hover:scale-105 hover:border-white/20 cursor-pointer shadow-[0_4px_12px_rgba(0,0,0,0.4)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.5),0_0_24px_rgba(255,255,255,0.08)]">
      <CardContent className="flex flex-col items-center justify-center text-center h-full p-3 sm:p-4">
        <span
