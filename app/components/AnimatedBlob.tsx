...
export default function AnimatedBlob() {
  ...
  useEffect(() => {
    ...
    const animateGradient = () => {
      ...
      const duration = randDur();
      gsap.to(gradStop1.current, { stopColor: c1, duration, ease: "power1.inOut" });
      gsap.to(gradStop2.current, { stopColor: c2, duration, ease: "power1.inOut" });
      ...
      gsap.to(gradStop4.current, { stopColor: c4, duration, ease: "power1.inOut" });
      gsap.to(gradStop5.current, { stopColor: c5, duration, ease: "power1.inOut" });
  ...
  return (
    ...
    >
      ...
      <path
        ...
        d={blobPaths[0]}
        fill="url(#blobGrad)"
        style={{ filter: "url(#innerGlow) drop-shadow(0 8px 32px rgba(255, 94, 98, 0.18))" }}
      />
    </svg>
  );
} 